...
// the daemon's core_service reached for the invokeRemoteMethod overload that has no
...
using logos::core_service::CallFailure;
using logos::core_service::callEnvelope;
using logos::core_service::dispatchRejection;
...
struct Lister {
    ...
    logos::core_service::MethodLister fn() const {
